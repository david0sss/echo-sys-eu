...
export default function App() {
  ...
  return (
    <div className="relative min-h-screen bg-[#0c0c0c] text-white font-sans flex flex-col">
      ...
      <div className="noise-bg z-10 pointer-events-none mix-blend-overlay opacity-30"></div>
      ...
      <TopNav />
      {/* Top Gradient */}
      <div className="fixed top-0 inset-x-0 h-[40vh] bg-gradient-to-b from-[#0c0c0c] via-[#0c0c0c]/80 to-transparent pointer-events-none z-40 hidden md:block" style={{ backdropFilter: 'blur(20px)', maskImage: 'linear-gradient(to bottom, black 0%, transparent 100%)', WebkitMaskImage: 'linear-gradient(to bottom, black 0%, transparent 100%)' }}></div>
